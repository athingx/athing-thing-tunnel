package com.github.athingx.athing.aliyun.tunnel.agent;
...
public class AppLauncher {
    ...
    private void printHelp() {
        try (final Scanner scanner = new Scanner(Objects.requireNonNull(getClass().getResourceAsStream("/com/github/athingx/athing/aliyun/tunnel/agent/help.txt")))) {
    ...
    private void launch() {
        ...
        try {
            final Tunnel tunnel = new Tunnel(config);
